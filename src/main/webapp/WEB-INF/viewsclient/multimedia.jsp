...
<script type="text/javascript" src="<%=basePath%>/static/js/jquery.SuperSlide.2.1.1.js"></script>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            //初始设计分类
            var classData=getAjaxData('<%=basePath%>/general/getGroupClass.do',{type:'道具分类'},false);
            if(classData!=null) {
                $('.fl_nav').html('');
...
<body>
   ...
   <div class="hlx_banner" style="background:url(<%=basePath%>/static/images/banner_djxp.png) no-repeat top center;"></div>
     ...
     <div class="wrap">
            ...
            <div class="hlx_fld">
              <table width="100%">
                 <tr>
                    <td width="110"><b>道具新品分类：</b></td>
                    <td><div class="fl_nav">
                       <a href="javascript:" class="on">全部</a>
                       <a href="javascript:">雪花</a>
                       <a href="javascript:">花海</a>
