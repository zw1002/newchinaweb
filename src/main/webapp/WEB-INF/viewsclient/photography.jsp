...
<body>
   ...
   <div class="hlx_banner" style="background:url(<%=basePath%>/static/images/banner_sytk.png) no-repeat top center;"></div>
     ...
     <div class="wrap">
            ...
            <div class="hlx_fld">
              <table width="100%">
                 <tr>
                    <td width="80"><b>摄影分类：</b></td>
                    <td><div class="fl_nav">
                       <a href="javascript:" class="on">全部</a>
                       <a href="javascript:">婚纱照</a>
                       <a href="javascript:">母婴照</a>
                       <a href="javascript:">宝宝照</a>
                     </div>
                    </td>
                 </tr>
