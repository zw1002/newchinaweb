...
<html>
	<head>
		...
		<script type="text/javascript">
			$(function() {
				...
				var submissionname=$("#submissionname").val();
				$("#total").text(submissionname);
			});
			//跳转到首页
			function toIndex(){
			...
			function orderPay(){
				var uid=$("#uid").val();
				document.location.href = '<%=basePath%>/graphpay/orderPay.do?uid='+uid;
			}
		</script>
	</head>
	<body>
	...
	<input id="submissionname" name="submissionname" type="hidden" value="<%= request.getAttribute("submissionname")%>"/>
		<header>
			<div class="top">
